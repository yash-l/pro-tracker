...
# Fix cookies for Android
app.config['SESSION_COOKIE_SECURE'] = False
app.config['SESSION_COOKIE_HTTPONLY'] = True
app.config['SESSION_COOKIE_SAMESITE'] = 'Lax'

# --- HELPERS ---
def get_tz(): return pytz.timezone(cfg['timezone'])
...
async def tracker_loop():
    if not cfg['is_setup_done']: return 
...
<div class="container">
    ...
    <div class="card">
        ...
        <form action="/update_profile" method="post">
            ...
            <button class="btn" style="background:#334155;">Save & Restart</button>
        </form>
...
async def do_setup():
    ...
    new_cfg['admin_password'] = form['pimport logging
import asyncio
import os
import sys
import json
